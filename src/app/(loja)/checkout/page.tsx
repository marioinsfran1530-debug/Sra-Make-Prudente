      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_340px] gap-6 mt-6 items-start">
        ...
        <aside className="lg:sticky lg:top-5">
          <div className="rounded-2xl bg-white border border-rosa/15 shadow-sm p-5">
            ...
            <p className="text-[11px] text-cinza mt-4 mb-4">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl font-bold text-sm text-white flex items-center justify-center gap-2 disabled:opacity-60 shadow-sm"
              style={{
                backgroundColor:
                  "#25D366",
              }}
